// additional-tasks\app.js
// confetti animation script <script src="https://cdn.jsdelivr.net/npm/canvas-confetti@1"></script>
...
const winSound = new Audio("assets/win.flac");
...
function checkForWinner() {
  if (userRoundsWon === 3 || computerRoundsWon === 3) {
    const winner = userRoundsWon === 3 ? "User" : "Computer";
    alert(`${winner} wins the best two out of three!`);
    ...
    if (winner === "User") {
      ...
      winSound.play();
      resultP.textContent = "User wins the best two out of three!";
    } else if (winner === "Computer") {
      loseSound.play();
      resultP.textContent = "Computer wins the best two out of three!";
    }

    setTimeout(() => resetGame(), 2000); // resetGame();
  }
}
